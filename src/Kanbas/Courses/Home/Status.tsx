...
import { FaHouse, FaBullhorn, FaRegBell } from "react-icons/fa6";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      {/* Complete the rest of the buttons (Choose Home Page, View Course Screen, New Announcement, New Analytics, View Course Notifications*/}
    </div>
);}
